...
// Controller -> view 를 반환하는 역할 (.jsp, .html .. )
@Controller
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		...
		// ViewResolver : webapp/WEB-INF/spring/appServlet/servlet-context.xml 에 관련된 정보 작성
		// prefix : /WEB-INF/views/
		// suffix : .jsp
		// ->	  /WEB-INF/views/hom.jsp
		// 화면 구성(.jsp, .js, .css ...) : 기본경로가 webapp 아래
		return "home";
	}
	...
	public String joinSuccess(@RequestParam("email") String email, Model model) {
		...
		return "joinSuccess";	// view만 반환 (데이터X)
	}
