...
import ColorList from './components/Ex02ColorList'
...
const Ex02 = () => {
    ...
    A. 깊숙히 위치한 컴포넌트에 데이터를 전달해야 할 경우,
        여러 컴포넌트에 연달아 Props를 전달해주어야 한다. => 불편, 실수가 잦음
        => Props Drilling 현상
    그래서 우리는 context로 상태를 전역적으로 관리해줄 것!

    ** 만드는 순서 **
    1. context를 생성해준다. (=하나의 보관하는 용도) (createContext) => export
    ...
    */
    ...
    return (
        ...
        // 3. 컴포넌트를 Context Provider로 감싸주기
